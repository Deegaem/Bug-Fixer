...
export class CommentsService {
  ...
  public delete(issueid: number, id: number): Observable<any> {
    return this.http.delete(`http://localhost:8083/ims-comments/resources/comments/${issueid}/${id}`,
      { responseType: 'text' }
    );
  }

  public deleteAll(issueid: number): Observable<any> {
    return this.http.delete(`http://localhost:8083/ims-comments/resources/comments/${issueid}`,
      { responseType: 'text' }
    );
  }
